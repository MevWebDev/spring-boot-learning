...
import com.mycompany.app.service.ImportService;
import com.mycompany.app.service.ImportSummary;
import com.mycompany.app.service.ApiService;
import com.mycompany.app.service.ApiException;
...
public class Main {
    public static void main(String[] args) {
        ...
        emp6.setSalary(2000); // Ustawienie wynagrodzenia dla stażysty
        ...
        String csvFilePath = "/Users/szymongrysiewicz/repos/spring-boot-learning/app/my-app/employees.csv"; // Assuming the file is in the root of the application
        ...
        String apiUrl = "https://jsonplaceholder.typicode.com/users"; // Przykładowy URL API
        ...
        // Wyświetlenie podsumowania importu
        ...
        System.out.println("\n\n=== WALIDACJA SPÓJNOŚCI WYNAGRODZEŃ ===");
        System.out.println("Pracownicy z wynagrodzeniem niższym niż bazowa stawka ich stanowiska:");
        List<Employee> inconsistentSalaries = service.validateSalaryConsistency();
        if (inconsistentSalaries.isEmpty()) {
            ...
            inconsistentSalaries.forEach(emp -> 
                System.out.printf("✗ %s (%s): Wynagrodzenie %.2f PLN < Bazowa stawka %.2f PLN\n",
                    emp.getFullName(),
                    emp.getPosition(),
                    emp.getSalary(),
        ...
        // ===== STATYSTYKI FIRM =====
        System.out.println("\n\n=== STATYSTYKI FIRM ===");
        Map<String, CompanyStatistics> companyStats = service.getCompanyStatistics();
        companyStats.forEach((companyName, stats) -> {
            System.out.println("\nFirma: " + companyName);
            System.out.println("  Liczba pracowników: " + stats.getEmployeeCount());
            System.out.printf("  Średnie wynagrodzenie: %.2f PLN\n", stats.getAverageSalary());
            System.out.println("  Najlepiej zarabiający: " + stats.getHighestPaidEmployee());
        });
